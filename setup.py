...
#
# START OF SECTION - Edit this section only
#

# List of extension modules ( = pybinded C++ modules )
pybind_simple_modules = [ "expose_modB1"
                        # , ""
                        ]


# {pybind module name, include dir, lib dir, bibs to link, source file}
pybind_linked_modules = [ {"name":"expose_modB2"
...
# name of the executable ( in add_executable in CMkaeList of tests/cpp/ ) to run from python unittest test_cpp.py
cpp_tests_executables = [ "modB1_test"
                            , "modB2_test"
                        ]

#
# END OF SECTION - Do not edit after this
#
#
...
setup(
    ...
    description='Template Python package using C++ code through pybind11 ',
    long_description='',
    package_dir={'':'src'},
